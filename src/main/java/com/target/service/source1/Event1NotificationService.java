package com.target.service.source1;
...
@Slf4j
@Service
public class Event1NotificationService extends BaseSource1Service implements INotificationService {
  ...
  public boolean supportsEvent(String eventType) {
    ...
    return EventEnum.EVENT1.toString().equalsIgnoreCase(eventType.toUpperCase());
  }

  @Override
  public Mono<NotificationResponse> notify(NotificationRequest request) {
    log.debug("HELLO ---- EVENT 1 notify");
